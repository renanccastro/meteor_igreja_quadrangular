...
if (Meteor.isClient) {
    ...
    Router.route('/loginMobile', {name: "loginMobile", template: 'LoginMobile',        waitOn: function() {
        return [
            Meteor.subscribe('posts'),
            Meteor.subscribe('messages'),
            Meteor.subscribe('recados'),
    ...
    Router.route('/memberCenter/messages/editmessage/:_id', {
            name: "editmessage", template: 'edit_message',
            data: function () {
